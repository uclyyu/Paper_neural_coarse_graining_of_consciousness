...
\rlstart{4}
        ...
        We starts our argument from a presumptive fact that every human conscious precept is highly informative. Our conscious experience always consists of high multidimensional information and usually involves information from multiple modalities. If we consider information as resolved uncertainty, every conscious percept rules out other enormous possible conscious states that we are able to experience. Therefore, every conscious percept resolves a huge amount of uncertainty and provides considerable information. 
        ...
        Based on this presumptive fact, we postulate that the amount of information possessed of a conscious percept should be equivalent to information that we can obtain from a particular physical event in the physical reality. For example, considering two physical systems (Alice and Bob) and there is no interaction (or information passing) in between. Assuming that Alice is conscious, the conscious experience that Alice has should not involve any information about Bob. 
        ...
        We further take a radical standpoint and postulate that consciousness fundamentally associates with information in the physical reality, i.e. information correlates of consciousness (ICC), \cite{chalmers1996conscious, tononi2004information, gamez2011information}) and discard the notion of neural correlates of consciousness(NCC). In sum, we consider consciousness is an information-based phenomenon and information is a common language between conscious experience and the physical world.
        
        We next consider the boundary problems of consciousness \cite{goff2006experiences}. Even though information involved in every conscious percept is extremely rich, it is still bounded, i.e. the boundaries of information exist in every conscious percept. Presuming consciousness is information-based, we can identify the boundaries by measures from information theory. Particularly in this case, boundaries can be defined by information closure. More importantly, our conscious experience always contains not merely trivial informational. Rather, it always provides rich information about the environmental and our bodily states. Therefore, we postulate that NTIC is a fundamental informational property associated with consciousness.
