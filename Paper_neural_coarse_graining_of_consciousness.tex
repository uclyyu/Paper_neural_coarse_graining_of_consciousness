...
%	   			   	\end{figure}
	...
	\section{Neural coarse-graining}
		...
		\begin{writingMaterials}				
			...
			@ It is important to note that NTIC should not be a monotonic function of scale of coarse-graining. For the extreme case xxxxx								
		...
		\subsection{\martin{todo}Neural coarse-graining}
			...
			\begin{ants}
				...
				@ Through two objectives during training, the model can achieve NTIC. \martin{todo}
