...
% 	{
%         \begin{mdframed}[%
%             frametitle=- Writing Materials,
%             frametitlefont={\small\color{white}},
%             middlelinecolor=Black,
%             shadow=true,
%             shadowsize=2mm,
%             frametitlebackgroundcolor=Aquamarine,
%             frametitlerule=true,
%             backgroundcolor=Aquamarine!10!white]
%         \noindent
%         \begin{easylist}[itemize]
% 	}
% 	{
...
% Functional content
	...
	% Highlight: Yellow or Red
		...
		\newcommand{\highlightAndComment}[3][Yellow!75!white]{\todo[color=#1, linecolor=Yellow]{#3}\fcolorbox{Black}{#1}{#2}}
...
\rlstart{3}
        ...
        For example, in the physical world, if there exists two systems Alice and Bob, but there is no information flow between them (or we can say no causal influence from one to the other). If we assume that Alice has consciousness experience, the information enclosed in Alice's conscious contents must not include any information about Bob. 
        
        We can treat information as a common language between conscious experience and physical world. 

        Through coarse-graining, to achieve NTIC processes becomes possible in the neural system at macroscopic levels. Therefore, coarse-graining becomes necessary because every individual sensor and neuron at the microscopic scale can only access and process very limited partial information (Fig. \ref{fig:LevelOfConsciousness}). In the following, ...
