...
%		\end{ants}
	...
	\section{Non-trivial informational closure\martin{todo}}
		...
		\subsection{Definition of informational closure}
			...
			\noindent However, achieving information closure (minimising $J_t$) could be trivial, which means the environment and the system are entirely independent of each other.
				\begin{equation}
				\begin{aligned}
			...
			\noindent In the non-trivial case, the system trying to encode environmental dynamic can also achieve informational closure. This means
				\begin{equation}
				I(Y_{t+1};E_{t})\neq0, 
				\end{equation}
			...
			\noindent And, non-trivial informational closure can be defined as 		
				\begin{equation}
				\left.\begin{array}
			...
			\noindent Therefore, Maximising NTIC is equivalent to
				\begin{equation}
				\begin{aligned}
